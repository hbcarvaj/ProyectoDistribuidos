  ...
  <div class="m-0 py-0">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 text-right"><a class="btn btn-secondary" href="blank.php">Eventos</a><a class="btn btn-primary" href="login.php">Iniciar sesión</a><a class="btn btn-light" href="signup.php">Regístrate</a></div>
      </div>
    </div>
  </div>
  <div class="py-2">
